    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < demons.Length; i++)
            {
                ...
                currDemonHealt = CalculateHealth(currDemonHealt, currDemonName);

                CalculateDamage(demonsDict, currDemonHealt, currDemonName);

            }
            PrintDemons(demonsDict);

        }

        private static int CalculateHealth(int currDemonHealt, string currDemonName)
        {
            ...
            return currDemonHealt;
        }

        private static void CalculateDamage(SortedDictionary<string, Dictionary<int, double>> demonsDict, int currDemonHealt, string currDemonName)
        {
            double currDamage = 0;
        ...
        private static void PrintDemons(SortedDictionary<string, Dictionary<int, double>> demonsDict)
        {
